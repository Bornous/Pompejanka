		...
		if ($bazaDanych->connect_errno!=0)
			...
			{ 
					...
					for( $i=1;$i<=$liczba_dni_w_mies;$i++){
						...
						if($bazaDanych->query("INSERT INTO zapisy ( dataDay, dataMonth, dataYear , imie, nazwisko, email, numerPomp) VALUES ('".$i."', '".$nowyMiesiac."', '".$year."' , ' ' , ' ', ' ' , '".$dzienPompejanki."' ,)") ){
							$sukcesy++;
						}
					...
					echo " . Pomyślnie zaaplikowano ".$sukcesy." rekordów. NOwyM=".$nowyMiesiac." a year to ".$year;
